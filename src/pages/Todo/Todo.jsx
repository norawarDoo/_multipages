  ...
  return (
    <div className="todo-container">
                  ...
                  <tr key={todo.id}>
                    ...
                    <td style={{ textAlign: "right" }}>
                      ...
                      {todo.completed ? (
                        ...
                        <button
                          className="btn btn-warning" onClick={() => { waitingClick(todo.id);
                          }}
                        >
                          waiting&nbsp;
                          <span className="bi bi-clock"></span>
                      ...
                      &nbsp;
                      <button
                        className="btn btn-danger" onClick={() => { deleteClick(todo.id);
                        }}
                      >
      ...
      <div>
        ...
        <button
          className={
            "todo-space btn " + (curPage <= 1 ? "btn-outline-secondary" : "btn-outline-primary")
          }
        ...
        <button
          className={
            "todo-space btn " + (curPage >= numPages? "btn-outline-secondary": "btn-outline-primary")}
