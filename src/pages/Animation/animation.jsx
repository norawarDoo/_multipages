    ...
    return (
        <div id="container">
            ...
            <div id="contrtol">
                ...
                <button id="basketballBtn" className="btn btn-warning" onClick={() => changeBallImage('./basketball.png')}>BASKETBALL</button>
                <button id="footballBtn" className="btn btn-secondary" onClick={() => changeBallImage('./ball1.jpg')}>FOOTBALL</button>
                <button id="volleyballBtn" className="btn btn-danger" onClick={() => changeBallImage('./volleyball.png')}>VOLLEYBALL</button>
                <button id="humanballBtn" className="btn btn-warning" onClick={() => changeBallImage('./numan.jpg')}>HUMAN</button>
                <button id="cartoonballBtn" className="btn btn-info" onClick={() => changeBallImage('./cartoon.jpg')}>CARTOON</button>
                <button id="logoballBtn" className="btn btn-dark" onClick={() => changeBallImage('./logo.png')}>LOGO</button>
            </div>
        </div>
    );
};
