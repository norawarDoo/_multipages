    ...
    <div className="navbar-container">
      ...
      <Link to="/calculator">
        <button
          className={
            "btn " +
            (tab === "calculator" ? "btn-primary" : "btn-outline-success")
          }
      ...
      <Link to="/animation">
        <button
          className={
            "btn " +
            (tab === "Animation" ? "btn-primary" : "btn-outline-secondary")
          }
      ...
      <Link to="/components">
        <button
          className={
            "btn " +
            (tab === "components" ? "btn-primary" : "btn-outline-danger")
          }
      ...
      <Link to="/todo">
        <button
          className={
            "btn " + (tab === "todo" ? "btn-primary" : "btn-outline-warning")
          }
          onClick={() => setTab("todo")}
        >
          Todo
      ...
      <Link to="/products">
        <button
          className={
            "btn " + (tab === "products" ? "btn-primary" : "btn-outline-info")
          }
